...
export const ITEM_CREATED = (typeNameSingular: string) => `${typeNameSingular} created`;
export const ITEM_UPDATED = (typeNameSingular: string) => `${typeNameSingular} updated`;
export const ITEM_DELETED = (typeNameSingular: string) => `${typeNameSingular} deleted`;
...
export const PROP_UPDATED = (prop: string) => `${prop} updated`;
